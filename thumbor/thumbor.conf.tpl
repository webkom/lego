...
## Defaults to: Thumbor/6.2.0
HTTP_LOADER_DEFAULT_USER_AGENT = '{{ HTTP_LOADER_DEFAULT_USER_AGENT | default('Thumbor/6.2.0') }}'
...
TC_AWS_ENDPOINT = '{{ TC_AWS_ENDPOINT | default('') }}' # AWS ENDPOINT
