...
class Migration(migrations.Migration):
    ...
    dependencies = [("users", "0008_auto_20171011_2112")]
    ...
    operations = [
        ...
        migrations.RemoveField(model_name="membership", name="end_date"),
        migrations.RemoveField(model_name="membership", name="start_date"),
    ]
