...
test_tree = {
    'UserAdminTest': [
        {
            'permissions': [
                '/sudo/admin/users/list/', '/sudo/admin/users/view/', '/sudo/admin/users/create/',
                '/sudo/admin/users/edit/', '/sudo/admin/users/delete/'
            ]
        }, {}
    ],
    'AbakusGroupAdminTest': [
        {
            'permissions': [
                '/sudo/admin/groups/list/', '/sudo/admin/groups/view/',
                '/sudo/admin/groups/create/', '/sudo/admin/groups/edit/',
    ...
    'EventAdminTest': [
        {
            'permissions': [
                '/sudo/admin/events/list/', '/sudo/admin/events/view/',
                '/sudo/admin/events/create/', '/sudo/admin/events/edit/',
    ...
    'APIApplicationTest': [
        {
            'permissions':
            ['/sudo/admin/apiapplications/list/', '/sudo/admin/apiapplications/create/']
        }, {}
    ],
    'QuoteAdminTest': [
        {
            'permissions': [
                '/sudo/admin/quotes/like/', '/sudo/admin/quotes/change-approval/',
                '/sudo/admin/quotes/list-unapproved/', '/sudo/admin/quotes/list/',
                '/sudo/admin/quotes/view/', '/sudo/admin/quotes/create/',
                '/sudo/admin/quotes/edit/', '/sudo/admin/quotes/delete/'
            ]
        }, {}
    ],
    'ReactionTest': [{
    ...
    'InterestGroupAdminTest': [
        {
            'permissions': [
                '/sudo/admin/interestgroups/list/', '/sudo/admin/interestgroups/view/',
                '/sudo/admin/interestgroups/create/', '/sudo/admin/interestgroups/edit/',
    ...
    'EmailAdminTest': [
        {
            'permissions':
            ['/sudo/admin/emailusers/', '/sudo/admin/emailgroups/', '/sudo/admin/emaillists/']
        }, {}
    ],
    'Users': [{
                    ...
                    'AbaBrygg': [
                        {
                            'permissions': [],
                            'description':
                            'Interessegruppe for AbaBrygg',
                            'text':
                            'Hender det seg at du tar en pils? Er lommeboken ofte tom, '
                    ...
                    'abaGolf': [
                        {
                            'permissions': [],
                            'description':
                            'Interessegruppe for abaGolf',
                            'text':
                            'Hei, er du en person som liker å klaske baller på grønne '
                    ...
                    'Turgruppa': [
                        {
                            'permissions': [],
                            'description':
                            'Interessegruppe for Turgruppa',
                            'text':
                            'Abakus sin turgruppe er for alle som elsker, liker eller har '
