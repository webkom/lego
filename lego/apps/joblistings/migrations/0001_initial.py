        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ('summer_job', 'summer_job'), ('other', 'other')
                        ], max_length=20
                    )
                ),
                (
                ...
                (
                    'company',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='joblistings',
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name='joblisting_created', to=settings.AUTH_USER_MODEL
                    )
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name='joblistings', to='companies.CompanyContact'
                    )
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        default=None, editable=False, null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name='joblisting_updated', to=settings.AUTH_USER_MODEL
                    )
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        default=None, editable=False, null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name='workplace_created', to=settings.AUTH_USER_MODEL
                    )
                ),
                (
                    'updated_by',
                    models.ForeignKey(
                        default=None, editable=False, null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name='workplace_updated', to=settings.AUTH_USER_MODEL
                    )
                ),
            ],
            options={
