...
NOTIFICATION_TYPES = [
    WEEKLY_MAIL, EVENT_BUMP, EVENT_ADMIN_REGISTRATION, EVENT_ADMIN_UNREGISTRATION,
    EVENT_PAYMENT_OVERDUE, EVENT_PAYMENT_OVERDUE_CREATOR, MEETING_INVITE, PENALTY_CREATION,
    RESTRICTED_MAIL_SENT, COMPANY_INTEREST_CREATED, COMMENT, COMMENT_REPLY, ANNOUNCEMENT
]
