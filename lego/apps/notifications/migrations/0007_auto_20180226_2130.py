...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('notifications', '0006_auto_20171210_1610'),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ('company_interest_created', 'company_interest_created'), ('comment',
                                                                               'comment'), ('comment_reply', 'comment_reply'),
                    ('announcement', 'announcement'), ('survey_created', 'survey_created')], max_length=64),
        ),
    ]
