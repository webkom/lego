...
ACHIEVEMENT_RARITIES = {
    ...
    EASTER_2024_IDENTIFIER: [2],
    EASTER_2025_IDENTIFIER: [1, 2],
    EASTER_2026_IDENTIFIER: [0, 1, 2],
    CHRISTMAS_CALENDAR_IDENTIFIER: [2],
    PERFECT_WEEK_IDENTIFIER: [3, 5],
}
...
ACHIEVEMENT_WEIGHTS = {
    ...
    EASTER_2024_IDENTIFIER: 1,
    EASTER_2025_IDENTIFIER: 1,
    EASTER_2026_IDENTIFIER: 1,
    CHRISTMAS_CALENDAR_IDENTIFIER: 1,
    PERFECT_WEEK_IDENTIFIER: 1,
}
