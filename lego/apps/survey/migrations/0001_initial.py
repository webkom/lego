# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-10-31 17:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alternative_type', models.PositiveSmallIntegerField(choices=[(1, 'radio_button'), (2, 'check_box'), (3, 'text_box')], default=1)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='survey.Alternative'),
        ),
        migrations.AddField(
            model_name='answer',
            name='submission',
