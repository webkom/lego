...
class GSuiteSystem(ExternalSystem):
    ...
    def filter_users(self, queryset):
        ...
        """
        return queryset.exclude(crypt_password_hash="").filter(
            internal_email__isnull=False, internal_email_enabled=True, is_active=True
        )
    ...
    def set_group_members(self, group_key, members):
        ...
        self.gsuite.set_memberships(
            group_key=group_key, member_keys=desired_member_emails
        )
