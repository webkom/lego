...
class TagViewSet(
    viewsets.mixins.ListModelMixin, viewsets.mixins.RetrieveModelMixin, viewsets.GenericViewSet
):
    ...
    def get_queryset(self):
        ...
        if self.action in ['popular', 'list']:
            # Usage count
            related_fields = [related.name for related in queryset.model._meta.related_objects]
