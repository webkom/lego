    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                related_name="companyinterest_created",
                to=settings.AUTH_USER_MODEL,
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                related_name="companyinterest_updated",
                to=settings.AUTH_USER_MODEL,
            ),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name="semesterstatus", unique_together=set([("semester", "company")])
        ),
        migrations.AlterUniqueTogether(
            name="semester", unique_together=set([("year", "semester")])
        ),
    ]
